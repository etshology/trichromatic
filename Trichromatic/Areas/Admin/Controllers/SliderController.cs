...
namespace Trichromatic.Areas.Admin.Controllers
{
    public class SliderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,Title,Description,Link,Image,SortOrder,Active")] Slider slider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,Title,Description,Link,Image,SortOrder,Active")] Slider slider)
        {
            if (ModelState.IsValid)
            {
